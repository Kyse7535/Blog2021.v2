    ...
    <main>
        <div class="container">
            ...
            <div class="row my-5 px-2">
                <div class="ligne2 col-12 d-flex justify-content-center align-items-center flex-wrap">
                    <form action="" class="mb-3">
                        <label for="nom">Nom</label><br>
                        <input type="text" name="nom" class="w-100"><br>
                        <label for="prenom">Prenom</label><br>
                        <input type="text" name="prenom" class="w-100"><br>
                    ...
                    <img src="Vue/CSS/image2.jpg" alt="description" class="img-fluid px-2">
                </div>
            </div>
        </div>
    </main>
