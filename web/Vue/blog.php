...
<main>
    ...
    <div class="container">
        ...
        <div class="row ligne px-2 position-relative">
            <?php
            while ($article = $resultat1->fetch()) {
                $monarticle = new article($article);
            ?>
            <div class="col-12 col-lg-8 text-right py-5 article">
                ...
                <figure>
                    <img src="fichiers/<?= $monarticle->getImg() ?>" alt="" class="img-fluid w-100 mb-2">
            ...
            <div class="col-lg-4 d-none d-lg-block latest-article">
        ...
        <div class="col-12 col-md-4 offset-md-2 text-center publish mb-4">
